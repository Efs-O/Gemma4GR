...
Requires: L4 (40 GB) or A100 (80 GB) — E4B needs 17 GB for LoRA.
This script is identical to E2B but targets E4B.
Deploy via: training/colab_e4b_audio.ipynb
"""
...
def train():
    ...
    if vram < 16:
        print("[WARN] E4B needs ~17 GB LoRA VRAM. Switch to L4 or A100 in Colab.")
